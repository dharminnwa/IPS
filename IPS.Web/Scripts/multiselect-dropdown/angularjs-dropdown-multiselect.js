...
directiveModule.directive('ngDropdownMultiselect', ['$filter', '$document', '$compile', '$parse', '$translate',
    function ($filter, $document, $compile, $parse, $translate) {
        ...
        return {
            ...
            template: function (element, attrs) {
                ...
                template += '<button style="width: 100%; text-align: left" type="button" class="dropdown-toggle" ng-class="settings.buttonClasses" ng-click="toggleDropdown()" ng-disabled="ngDisabled">{{getButtonText()}}&nbsp;<span style="float: right; vertical-align:middle;margin-top: 10px" class="caret"></span></button>';
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.texts = {
                    //checkAll: 'Check All',
                    checkAll: $translate.instant('DASHBOARD_CHECK_ALL'),// 'Check All',
                    //uncheckAll: 'Uncheck All',
                    uncheckAll: $translate.instant('DASHBOARD_UNCHECK_ALL'),//'Uncheck All',
