...
(function (kendo, $) {
    ...
    var ExtDropDownTreeView = kendo.ui.Widget.extend({
        ...
        init: function (element, options) {
            ...
            var maxZ = 10000 + Math.max.apply(null,
            ...
            $('body').append(kendo.format("<div id='extTreeView{0}' class='k-animation-container k-ext-treeview' style='z-index:" + maxZ + ";'/>", that._uid));
