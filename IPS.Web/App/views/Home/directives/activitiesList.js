                    ...
                    if (reminderData.isSelfEvaluation) {
                        if (reminderData && reminderData.profile) {
                            return {
                                ...
                                link: '#/home/activeProfiles/survey/' + reminderData.profile.id + '/' + reminderData.stage.id + '/' + reminderData.evaluator.id + '/' + isStandAloneMode + '',
                ...
                function checkSetKPI(reminderData) {
                    if (reminderData.isSelfEvaluation) {
                            return {
                                ...
                                link: '#/home/KPI/' + reminderData.profile.id + '/' + reminderData.stage.id + '/' + reminderData.evaluator.id,// + '/' + reminderData.evaluator.id,
                                dueDate: reminderData.dueDate,
                                id: reminderData.id,
                                stageEndDate: reminderData.stage.endDateTime
                        }
                            ...
                            return {
                                ...
                                link: '#/home/KPI/' + reminderData.profile.id + '/' + reminderData.stage.id + '/' + reminderData.evaluator.id,// + '/' + reminderData.evaluatee.id,
                                dueDate: reminderData.dueDate,
                                id: reminderData.id,
                                stageEndDate: reminderData.stage.endDateTime
                        }
