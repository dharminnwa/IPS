...
angular.module('ips.performanceGroups')
    .controller('SoftPerformanceGroupEditCtrl', ['$scope', '$location', 'authService', 'apiService', '$stateParams',
        ...
        function ($scope, $location, authService, apiService, $stateParams, $window, $rootScope, cssInjector, profilesService,
            ...
            $scope.tabsTemplates = ['../app/views/performanceGroups/tabTemplates/skills.html', '../app/views/performanceGroups/tabTemplates/soft-questions.html', '../app/views/performanceGroups/tabTemplates/trainings.html', '../app/views/performanceGroups/tabTemplates/balanceScorecard.html'];
