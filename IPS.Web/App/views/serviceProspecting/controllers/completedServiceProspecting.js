angular.module('ips.serviceProspecting')
    .config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
        var completedServiceProspectingResolve = {
        ...
        $stateProvider
            .state('home.serviceProspecting.completedServiceProspecting', {
                url: "/completedServiceProspecting",
                templateUrl: "views/serviceProspecting/views/completedServiceProspecting.html",
                controller: "CompletedServiceProspectingCtrl",
                resolve: completedServiceProspectingResolve,
                data: {
    ...
    .controller("CompletedServiceProspectingCtrl", ['$scope', 'cssInjector', '$stateParams', '$location', 'todoManager', 'todosManager', 'serviceProspectingManager', 'dialogService', 'progressBar', 'localStorageService', '$compile', 'projectRolesEnum', '$translate', 'prospectingTypesEnum', 'globalVariables',
