...
angular.module('ips.profiles')
    .config(['$stateProvider', function ($stateProvider) {
        ...
        var stateEditPerformanceGroupResolve = {
            ...
            performanceGroup: function ($stateParams, performanceGroupsService) {
                if ($stateParams.profileId > 0) {
                    return performanceGroupsService.getById(0, $stateParams.profileId);
                }
                else {
                    return performanceGroupsService.getById(0, 0);
                }
            },
            ...
            performanceGroupsFilter: function ($stateParams, performanceGroupsService, profileTypeId) {
                if ($stateParams.profileId > 0) {
                    ...
                    return performanceGroupsService.getAllPerformanceGroups("&$filter=ProfileId eq 0");
                }
            },
        ...
        $stateProvider.state('home.softprofile', {
            url: "/soft/profile/:profileId",
            resolve: stateResolveConfig,
            controller: 'SoftProfileCtrl',
            templateUrl: "views/profiles/newsoftprofile.html",
            data: {
        ...
        $stateProvider.state('home.softperformancegroups', {
            url: "/soft/:profileId/performancegroups",
            resolve: stateEditPerformanceGroupResolve,
            controller: 'ProfilePerformanceGroupsCtrl',
        ...
        $stateProvider.state('home.softskills', {
            url: "/soft/:profileId/skills",
        ...
        $stateProvider.state('home.softQuestions', {
            url: "/soft/:profileId/questions",
        ...
        $stateProvider.state('home.softTrainings', {
            url: "/soft/:profileId/trainings",
        ...
        $stateProvider.state('home.softMilestones', {
            url: "/soft/:profileId/milestones",
            resolve: stateProfileMilestonesResolve,
            controller: 'ProfileMilestonesCtrl',
        ...
        $stateProvider.state('home.softParticipants', {
            url: "/soft/:profileId/participants",
            resolve: stateProfileParticipantsResolve,
            controller: 'ProfileParticipantsCtrl',
        ...
        $stateProvider.state('home.softStatus', {
            url: "/soft/:profileId/status",
            resolve: stateProfileStatusResolve,
            controller: 'ProfileStatusCtrl',
        ...
        $stateProvider.state('home.softHistory', {
            url: "/soft/:profileId/history",
            resolve: stateProfileStatusResolve,
    ...
    .controller('SoftProfileCtrl', ['$scope',
        '$location', 'authService', 'apiService', '$stateParams', '$window', '$rootScope',
        'cssInjector', 'profilesService', 'profileTagService', '$state', 'profile', 'isInUse', 'industries',
        'profileLevels', 'jobTitles', 'scales', 'organizations', 'profileCategories',
        'scaleSettingsRules', 'profileTags', 'projects', 'dialogService', 'treeItems', '$controller', '$translate', 'localStorageService',
    ...
    .controller('ProfilePerformanceGroupsCtrl', ['$scope', 'localStorageService', 'authService', 'profilesService', 'apiService', '$window',
        ...
        function ($scope, localStorageService, authService, profilesService, apiService, $window, $rootScope, cssInjector,
            ...
            $scope.gotoSkills = function () {
                if (($scope.profileId > 0) && ($scope.performanceGroups.length > 0)) {
                    $location.path("/home/soft/" + $scope.profileId + "/skills");
                }
                else {
            ...
            $scope.gotoQuestions = function () {
                if (($scope.profileId > 0) && ($scope.performanceGroups.length > 0)) {
                    $location.path("/home/soft/" + $scope.profileId + "/questions");
                }
                else {
                    dialogService.showNotification($translate.instant("MYPROJECTS_PROJECTPROFILES_PLEASE_ADD_PERFORMANCE_GROUP_IN_PERFORMANCE_GROUP_SETUP"), "error");
                }
            ...
            $scope.gotoTrainings = function () {
                if (($scope.profileId > 0) && ($scope.performanceGroups.length > 0)) {
                    $location.path("/home/soft/" + $scope.profileId + "/trainings");
    ...
    .controller('ProfileSkillsCtrl', ['$scope', 'localStorageService', 'authService', 'apiService',
    ...
    .controller('ProfileQuestionsCtrl', ['$scope', 'localStorageService', 'authService', 'apiService',
        'cssInjector', 'performanceGroupsService', '$stateParams', '$state', 'dialogService',
        'performanceGroups', 'isProfileInUse', 'profileTypeEnum', 'skills', 'profileTypeId', '$translate', '$location',
        function ($scope, localStorageService, authService, apiService, cssInjector, performanceGroupsService,
            ...
            $scope.questionsGridOptions = {
                ...
                //    },
                //    { field: "questionText", title: $translate.instant('SOFTPROFILE_QUESTION'), width: '30%' },
                //    {
                //        field: "seqNo",
                //        title: $translate.instant('SOFTPROFILE_ORDER'),
                //        width: "10%",
                ...
                //            "<a class='fa fa-pencil fa-lg' ng-click='editQuestion(dataItem.id)' ng-disabled=\"isDisabled()\"></a>" +
                //            "<a class='fa fa-trash fa-lg' ng-click='removeQuestion(dataItem.id)' ng-disabled=\"isDisabled()\"></a>" +
                //            "</div>"
                //    }
                //]
            }
    ...
    .controller('ProfileTrainingsCtrl', ['$scope', 'localStorageService', 'authService', 'apiService',
        ...
        function ($scope, localStorageService, authService, apiService, cssInjector, performanceGroupsService, profileTrainingManager,
            ...
            $scope.gotoMilestones = function () {
                $location.path("/home/soft/" + $scope.profileId + "/milestones");
            }

        }])
    .controller('ProfileMilestonesCtrl', ['$scope', 'localStorageService', 'authService', 'apiService', 'dialogService', 'cssInjector', '$stateParams', 'profile', 'profileTypeEnum', 'projectInfo', 'notificationTemplates', 'profilesService', 'stageGroupManager', '$translate', 'globalVariables', 'templateTypeEnum', 'stageTypesEnum', 'evaluationRolesEnum', '$location',
        function ($scope, localStorageService, authService, apiService, dialogService, cssInjector, $stateParams, profile, profileTypeEnum, projectInfo, notificationTemplates, profilesService, stageGroupManager, $translate, globalVariables, templateTypeEnum, stageTypesEnum, evaluationRolesEnum, $location) {
            ...
            $scope.setManagerResultNotificationTemplates = function () {
                ...
                if ($scope.isStartStage) {
                    filterTemplate = _.find(notificationTemplates, function (item) {
                        return item.culture.cultureName == globalVariables.lang.currentUICulture && item.stageTypeId == stageTypesEnum.StartProfile && item.notificationTemplateTypeId == templateTypeEnum.MilestoneResultNotification && item.evaluationRoleId == evaluationRolesEnum.manager && item.isDefualt == true;
                    });
                }
                else {
                    filterTemplate = _.find(notificationTemplates, function (item) {
            ...
            $scope.gotoStatus = function () {
                if (($scope.profileId > 0) && ($scope.profile.stageGroups.length > 0)) {
                    $location.path("/home/soft/" + $scope.profileId + "/status");
            ...
            $scope.gotoHistory = function () {
                if (($scope.profileId > 0) && ($scope.profile.stageGroups.length > 0)) {
                    $location.path("/home/soft/" + $scope.profileId + "/history");
    ...
    .controller('ProfileStatusCtrl', ['$scope', 'localStorageService', 'authService', 'apiService', 'dialogService', 'cssInjector', '$stateParams', 'profile', 'profileTypeEnum', 'projectInfo', 'notificationTemplates', 'profilesService', 'stageGroupManager', '$translate', 'globalVariables', 'templateTypeEnum', 'stageTypesEnum', 'evaluationRolesEnum',
    ...
    .controller('ProfileHistoryCtrl', ['$scope', 'localStorageService', 'authService', 'apiService', 'dialogService', 'cssInjector', '$stateParams', 'profile', 'profileTypeEnum', 'projectInfo', 'notificationTemplates', 'profilesService', 'stageGroupManager', '$translate', 'globalVariables', 'templateTypeEnum', 'stageTypesEnum', 'evaluationRolesEnum',
        function ($scope, localStorageService, authService, apiService, dialogService, cssInjector, $stateParams, profile, profileTypeEnum, projectInfo, notificationTemplates, profilesService, stageGroupManager, $translate, globalVariables, templateTypeEnum, stageTypesEnum, evaluationRolesEnum) {
            cssInjector.add('views/profiles/new-soft-profile.css');
            var authData = localStorageService.get('authorizationData');
            $scope.currentUser = authData.user;
