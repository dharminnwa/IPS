angular.module('ips.taskProspecting')
    .config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
        ...
        var upcomingSalesProspectingResolve = {
        ...
        $stateProvider
            ...
            .state('home.salesProspecting.upcomingSalesProspecting', {
                url: "/upcomingSalesProspecting",
                templateUrl: "views/taskProspecting/views/upcomingSalesProspecting.html",
                controller: "UpcomingSalesProspectingCtrl",
                resolve: upcomingSalesProspectingResolve,
                data: {
    ...
    .controller("UpcomingSalesProspectingCtrl", ['$scope', 'cssInjector', '$stateParams', '$location', 'todoManager', 'todosManager', 'taskProspectingManager', 'dialogService', 'progressBar', 'localStorageService', '$compile', 'projectRolesEnum', '$translate', 'prospectingTypesEnum', 'globalVariables',
