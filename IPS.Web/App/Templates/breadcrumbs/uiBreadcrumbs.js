...
(function () {
    ...
    var templateUrl = 'templates/breadcrumbs/uiBreadcrumbs.tpl.html';
                ...
                function updateBreadcrumbsArray() {
                    ...
                    while (currentState && currentState.name !== '') {
                        ...
                        if (workingState) {
                            ...
                            if (displayName !== false && workingState.name != "home" && !stateAlreadyInBreadcrumbs(workingState, breadcrumbs)) {
                                breadcrumbs.push({
