(function () {
    app
        ...
        .directive('ngDashboard', ['$compile', function ($compile) {
            return {
                restrict: 'EA',
                templateUrl: 'directives/ngDashboard/ngDashboard.html',
                scope: {
                    ngReportData: '=',
                    ngCompareReportData: '=?',
                    profileId: '=',
                ...
                controller: ['$scope', '$location', '$compile', 'apiService', 'dialogService', '$element', 'profilesTypesEnum', 'resulTypesEnum',
                    ...
                    function ($scope, $location, $compile, apiService, dialogService, $element, profilesTypesEnum, resulTypesEnum,
                        ...
                        function drawPerfomanceGraph(container, elementId, perfomanceGroup, colorSeries, startHtml, endHtml, width, height) {
                            ...
                            graphElemHtml += "<div class='GraphListImg' ng-show='ngReportData.showGraph'>";
                            ...
                            graphElemHtml += "</div>";
                            graphElemHtml += "</div>";
                            graphElemHtml += "<h3 class='pgName' ng-show='ngReportData.showGraph'>" + perfomanceGroup.name + "</h3>";
                            graphElemHtml += "<div class='GraphListTxt' ng-show='ngReportData.showGraph' >";
                            ...
                            graphElemHtml += "<div class=''>" + reportModel.label + "</div>";
                            ...
                            if (reportModel.isShowBenchmark) {
                                graphElemHtml += "<div class='GraphLiProc width80Perc FloatLeft' ng-show='ngReportData.showGraph'>";
                            ...
                            if (perfomanceGroup.cScore && reportModel.cLabel != "") {
                                graphElemHtml += "<div class='GraphLiProc width80Perc FloatLeft' ng-show='ngReportData.showGraph'>";
                                graphElemHtml += "<div class=''>" + reportModel.cLabel + "</div>";
                            ...
                            if (reportModel.evaluatorsProfileScorecards) {
                                if (reportModel.evaluatorsProfileScorecards.length > 0) {
                                    if (reportModel.evaluatorsProfileScorecards[0].label) {
                                        graphElemHtml += "<div class='GraphLiProc width80Perc FloatLeft' ng-show='ngReportData.showGraph'>";
                                        graphElemHtml += "<div class=''>" + reportModel.evaluatorsProfileScorecards[0].label + "</div>";
                            ...
                            if (reportModel.cEvaluatorsProfileScorecards) {
                                if (reportModel.cEvaluatorsProfileScorecards.length > 0) {
                                    if (reportModel.cEvaluatorsProfileScorecards[0].label) {
                                        graphElemHtml += "<div class='GraphLiProc width80Perc FloatLeft' ng-show='ngReportData.showGraph'>";
                                        graphElemHtml += "<div class=''>" + reportModel.cEvaluatorsProfileScorecards[0].label + "</div>";
                            ...
                            if (perfomanceGroup && perfomanceGroup.score) {
                                ...
                                if (perfomanceGroup.score && perfomanceGroup.score > 0) {
                                    ...
                                    kendoPointers.push({ value: perfomanceGroup.score, color: scoreColor, label: reportModel.label + mainLegendPostfix });
                                }
                            ...
                            if (perfomanceGroup && perfomanceGroup.cScore && reportModel.cLabel != "") {
                                ...
                                if (perfomanceGroup.cScore && perfomanceGroup.cScore > 0) {
                                    ...
                                    kendoPointers.push({ value: perfomanceGroup.cScore, color: cScoreColor, label: reportModel.cLabel + compareLegendPostfix });
                                }
                                if (pointscores.length > 0) {
                                    var totalScores = _.sum(pointscores);
                                    ...
                                    if (avg > 0) {
                                        if (avgc > avg) {
                                            ...
                                            graphElemHtml += "<img src='images/dashboard/top-arrow-green.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px'>";
                                        } else if (avg == avgc) {
                                            graphElemHtml += "<img src='images/dashboard/min-icon-big.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px'>";
                                        } else {
                                            graphElemHtml += "<img src='images/dashboard/botm-arrow-red.png' style='width:15px;height:15px;padding-left:5px;;padding-top: 18px'>";
                                        }
                                    }
                            ...
                            if (reportModel.isShowBenchmark) {
                                ...
                                if (pointscores.length > 0) {
                                    ...
                                    var diffPercentage = setDiffrencePercentage(avg, benchmarkavg, reportModel.max); //parseFloat((((avgc - avg) / reportModel.max) * 100)).toFixed(1);
                            ...
                            if (reportModel.isShowGoal) {
                                ...
                                if (perfomanceGroup.goal && perfomanceGroup.goal > 0) {
                                    kendoPointers.push({
                                        value: perfomanceGroup.goal, color: goalColor, label: reportModel.label + " " + $translate.instant('DASHBOARD_GOALS') });
                                }
                            }
                            ...
                            if (reportModel.isShowCompareGoal && perfomanceGroup.cGoal) {
                                ...
                                if (perfomanceGroup.cGoal && perfomanceGroup.cGoal > 0) {
                                    kendoPointers.push({
                                        value: perfomanceGroup.cGoal, color: cGoalColor, label: reportModel.cLabel + " " + $translate.instant('DASHBOARD_GOALS') });
                                }
                            }
                            ...
                            if (evaluatorsSkillsForPg && evaluatorsSkillsForPg.length > 0) {
                                ...
                                angular.forEach(evaluatorsSkillsForPg, function (evaluatorDataForGraph, index) {
                                    ...
                                    if (evaluatorDataForGraph.score && evaluatorDataForGraph.score > 0) {
                                        ...
                                        kendoPointers.push({ value: evaluatorDataForGraph.score, color: evaluatorColor, label: evaluatorDataForGraph.label + mainLegendPostfix });
                                    }
                                });
                                if (pointscores.length > 0) {
                                    var totalScores = _.sum(pointscores);
                                    ...
                                    var mainEvalutorAVGHtml = "";
                                    if (avg > 0) {
                                        if (mainEvalutorAVG > avg) {
                                            mainEvalutorAVGHtml += "<img src='images/dashboard/top-arrow-green.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px'>";
                                        } else if (avg == mainEvalutorAVG) {
                                            mainEvalutorAVGHtml += "<img src='images/dashboard/min-icon-big.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px'>";
                                        } else {
                                            mainEvalutorAVGHtml += "<img src='images/dashboard/botm-arrow-red.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px'>";
                                        }
                                    }
                                    //mainEvalutorAVGHtml += "</div>";
                                    //$(".mainEvalutorAVG" + elementId).parent(".GraphLiProc").after(mainEvalutorAVGHtml);
                                    mainEvalutorAVGHtml += "<span>" + diffPercentage + "%</span>";
                                    var diffPercentage = setDiffrencePercentage(avg, mainEvalutorAVG, reportModel.max); //parseFloat((((avgc - avg) / reportModel.max) * 100)).toFixed(1);
                                    mainEvalutorAVGHtml += diffPercentage;
                                    $(".mainEvalutorAVG" + elementId).after(mainEvalutorAVGHtml);
                                }
                                else {
                                    if (reportModel.profileTypeName == "Agreed Final KPI") {
                                        ...
                                        if (avg > 0) {
                                            if (mainEvalutorAVG > avg) {
                                                mainEvalutorAVGHtml += "<img src='images/dashboard/top-arrow-green.png' style='width:15px;height:15px;float:left;margin-left: 5px;;padding-top: 18px'>";
                                            } else if (avg == mainEvalutorAVG) {
                                                mainEvalutorAVGHtml += "<img src='images/dashboard/min-icon-big.png' style='width:15px;height:15px;float:left;margin-left: 5px;;padding-top: 18px'>";
                                            } else {
                                                mainEvalutorAVGHtml += "<img src='images/dashboard/botm-arrow-red.png' style='width:15px;height:15px;float:left;margin-left: 5px;;padding-top: 18px'>";
                                            }
                                        }
                                        var diffPercentage = setDiffrencePercentage(avg, mainEvalutorAVG, reportModel.max); //parseFloat((((avgc - avg) / reportModel.max) * 100)).toFixed(1);
                                        mainEvalutorAVGHtml += diffPercentage;
                            ...
                            if (cEvaluatorsSkillsForPg && cEvaluatorsSkillsForPg.length > 0) {
                                ...
                                angular.forEach(cEvaluatorsSkillsForPg, function (evaluatorDataForGraph, index) {
                                    ...
                                    if (evaluatorDataForGraph.score && evaluatorDataForGraph.score > 0) {
                                        pointscores.push(evaluatorDataForGraph.score);
                                        kendoPointers.push({ value: evaluatorDataForGraph.score, color: cEvaluatorColor, label: evaluatorDataForGraph.label + compareLegendPostfix });
                                    }
                                });
                                ...
                                if (pointscores.length > 0) {
                                    ...
                                    var compareEvaluatorAVGHtml = "";
                                    if (avg > 0) {
                                        if (compareEvaluatorAVG > avg) {
                                            compareEvaluatorAVGHtml += "<img src='images/dashboard/top-arrow-green.png' style='width:15px;height:15px;float:left;margin-left: 5px;;padding-top: 18px'>";
                                        } else if (avg == compareEvaluatorAVG) {
                                            compareEvaluatorAVGHtml += "<img src='images/dashboard/min-icon-big.png' style='width:15px;height:15px;float:left;margin-left: 5px;;padding-top: 18px'>";
                                        } else {
                                            compareEvaluatorAVGHtml += "<img src='images/dashboard/botm-arrow-red.png' style='width:15px;height:15px;float:left;margin-left: 5px;;padding-top: 18px'>";
                                        }
                                    }
                                    var diffPercentage = setDiffrencePercentage(avg, compareEvaluatorAVG, reportModel.max); //parseFloat((((avgc - avg) / reportModel.max) * 100)).toFixed(1);
                                    compareEvaluatorAVGHtml += diffPercentage;
                                    //compareEvaluatorAVGHtml += "</div>";
                                    //$(".compareEvaluatorAVG" + elementId).parent(".GraphLiProc").after(compareEvaluatorAVGHtml);
                                    $(".compareEvaluatorAVG" + elementId).after(compareEvaluatorAVGHtml);
                        ...
                        function getKPIImage(avg, avgc) {
                            var imageElemHtml = "";
                            if (avg > avgc) {
                                imageElemHtml += "<img src='images/dashboard/top-arrow-green.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px;padding-bottom: 5px'>";
                            } else if (avg == avgc) {
                                imageElemHtml += "<img src='images/dashboard/min-icon-big.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px;padding-bottom: 5px'>";
                            } else {
                                imageElemHtml += "<img src='images/dashboard/botm-arrow-red.png' style='width:15px;height:15px;padding-left:5px;padding-top: 18px;padding-bottom: 5px'>";
                            }
                            var diffPercentage = setDiffrencePercentage(avgc, avg, reportModel.max); //parseFloat((((avgc - avg) / reportModel.max) * 100)).toFixed(1);
                        ...
                        $scope.getKTDevelopmentContractDetail = function () {
                            //"Final KPI of " + $scope.ngReportData.mainParticipantsRaw.split(",")[0],
                            dialogService.showKTDevelopmentContractDetailDialog($scope.profileId, $scope.ngReportData.stageId, $scope.ngReportData.participantsId[0].id, $scope.stageEvolutionId);
                        ...
                        function getKTScorecardData() {
                            ...
                            scorecardsServiceNew.loadKTScorecardData($scope.profileId, $scope.ngReportData.participantsId,
                                $scope.ngReportData.stageId, $scope.ngReportData.mainProfileStepId == ktProfileTypes.start.id, $scope.ngReportData.mainEvolutionStageId).then(function (data) {
                                    ...
                                    if ($scope.ngReportData.cParticipantIds.length > 0 && $scope.ngReportData.cEvaluatorsProfileScorecards.length > 0) {
                                        if ($scope.ngReportData.cParticipantIds.length > 0) {
                                            scorecardsServiceNew.loadKTScorecardData($scope.profileId, $scope.ngReportData.cParticipantIds,
                                                $scope.ngReportData.stageId, $scope.ngReportData.mainProfileStepId == ktProfileTypes.start.id, $scope.ngReportData.evolutionStageId).then(function (data) {
                                                        ...
                                                        $scope.ngReportData.stageId, $scope.ngReportData.mainProfileStepId == ktProfileTypes.start.id, $scope.ngReportData.evolutionStageId).then(function (data) {
                                                            ...
                                                            if ($scope.ngReportData.isShowBenchmark) {
                                                                ...
                                                                scorecardsServiceNew.loadKTScorecardData($scope.profileId, [{ id: -1 }],
                                                                    $scope.ngReportData.stageId, $scope.ngReportData.mainProfileStepId == ktProfileTypes.start.id, 0).then(function (data) {
                                ...
                                $scope.ngReportData.stageId, $scope.ngReportData.mainProfileStepId == ktProfileTypes.start.id, $scope.ngReportData.mainEvolutionStageId).then(function (data) {
                                    ...
                                    surveyService.getKTSurveyResult($scope.profileId.toString(), $scope.ngReportData.stageId.toString(), $scope.ngReportData.participantsId[0].id.toString(), "null").then(function (answerdata) {
                                        ...
                                        if (!($scope.ngReportData.cParticipantIds.length > 0)) {
                                            ...
                                            scorecardsServiceNew.loadKTScorecardData($scope.profileId, $scope.ngReportData.cParticipantIds,
                                                $scope.ngReportData.stageId, $scope.ngReportData.mainProfileStepId == ktProfileTypes.start.id, $scope.ngReportData.evolutionStageId).then(function (compData) {
                                        ...
                                        if (treeGrid.length > 0) {
                                            ...
                                            if ($scope.ngReportData.mainParticipantsModel.length > 0) {
                                                $scope.scorecard.legends.push(getLegendNames($scope.ngReportData.mainParticipantsModel, colorMainPart, $scope.ngReportData.mainParticipantsOptions, mainPostfix));
                                                showReport = true;
                                            }
                                            if ($scope.ngReportData.participantsModel.length > 0) {
                                                $scope.scorecard.legends.push(getLegendNames($scope.ngReportData.participantsModel, colorComparePart, $scope.ngReportData.participantsOptions, postfix));
                                                showReport = true;
                                            }
                                        }
                                        else {
                        ...
                        $scope.load = function () {
                            ...
                            if (!isNaN(reportModel.strongAverageScore)) {
                                $('#gauge_total_strong_value').html("<span style='color:" + gaugeSeriesColors.main + "; display: inline-block;'>" + parseFloat(reportModel.strongAverageScore).toFixed(1) + "</span>");
                                if ($scope.ngReportData.isShowBenchmark) {
                                    var benchmarkAvg = 0;
                                    var benchmarkTotal = 0;
                                    _.each(reportModel.performanceGroups, function (pgItem) {
        ...
        .directive('ktScoreCardDetail', ['$compile', function ($compile) {
            return {
                restrict: 'EA',
        ...
        .directive('ktAnswerDetail', ['$compile', function ($compile) {
            return {
                restrict: 'EA',
        ...
        .directive('ktDevelopmentContract', ['$compile', function ($compile) {
            return {
                restrict: 'EA',
