    ...
    return {
        ...
        initCharts: function() {
			...
			if ($('#site_activities').size() != 0) {
                ...
                var plot_statistics = $.plot($("#site_activities"),//open
			...
			if ($('#site_activities1').size() != 0) {
                ...
                var plot_statistics1 = $.plot($("#site_activities1"),//open
			...
			if ($('#site_activities2').size() != 0) {
                ...
                var plot_statistics2 = $.plot($("#site_activities2"),//open
			...
			//Start Chart 2 default
			
			
			//Start Chart 3 default
			if ($('#site_activities3').size() != 0) {
                //site activities
                var previousPoint2 = null;
                $('#site_activities_loading3').hide();
                $('#site_activities_content3').show();
                ...
                var plot_statistics1 = $.plot($("#site_activities3"),//open
...

                    {
						...
						//open
                $("#site_activities3").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                ...
                $('#site_activities3').bind("mouseleave", function() {
                    $("#tooltip").remove();
                });
            }
			...
			//Start Chart 4 default
			if ($('#site_activities4').size() != 0) {
                //site activities
                var previousPoint2 = null;
                $('#site_activities_loading4').hide();
                $('#site_activities_content4').show();
                ...
                var plot_statistics4 = $.plot($("#site_activities4"),//open
...

                    {
						...
						//open
                $("#site_activities4").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                ...
                $('#site_activities4').bind("mouseleave", function() {
                    $("#tooltip").remove();
                });
            }
			...
			//Start Chart 5 default
			if ($('#site_activities5').size() != 0) {
                //site activities
                var previousPoint2 = null;
                $('#site_activities_loading5').hide();
                $('#site_activities_content5').show();
                ...
                var plot_statistics5 = $.plot($("#site_activities5"),//open
...

                    {
						...
						//open
                $("#site_activities5").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                ...
                $('#site_activities5').bind("mouseleave", function() {
                    $("#tooltip").remove();
                });
            }
			...
			//Start Chart 5 default
			if ($('#site_activities6').size() != 0) {
                //site activities
                var previousPoint2 = null;
                $('#site_activities_loading6').hide();
                $('#site_activities_content6').show();
                ...
                var plot_statistics6 = $.plot($("#site_activities6"),//open
...

                    {
						...
						//open
                $("#site_activities6").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                ...
                $('#site_activities6').bind("mouseleave", function() {
                    $("#tooltip").remove();
                });
            }
			...
			/*---------------------*/
			if ($('#site_activities7').size() != 0) {
                //site activities
                var previousPoint2 = null;
                $('#site_activities_loading7').hide();
                $('#site_activities_content7').show();
                ...
                var plot_statistics7 = $.plot($("#site_activities7"),//open
...

                    {
						...
						//open
                $("#site_activities7").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                ...
                $('#site_activities7').bind("mouseleave", function() {
                    $("#tooltip").remove();
                });
            }
			
			/*---------------------*/
			if ($('#site_activities8').size() != 0) {
                //site activities
                var previousPoint2 = null;
                $('#site_activities_loading8').hide();
                $('#site_activities_content8').show();
                ...
                var plot_statistics8 = $.plot($("#site_activities8"),//open
...

                    {
						...
						//open
                $("#site_activities8").bind("plothover", function(event, pos, item) {
                    $("#x").text(pos.x.toFixed(2));
                    $("#y").text(pos.y.toFixed(2));
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                ...
                $('#site_activities8').bind("mouseleave", function() {
                    $("#tooltip").remove();
                });
            }
